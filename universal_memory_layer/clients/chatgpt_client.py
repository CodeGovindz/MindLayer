"""ChatGPT client implementation using OpenAI API."""
...
class ChatGPTClient(BaseLLMClient):
    ...
    def chat(self, message: str, context: Optional[List[str]] = None) -> str:
        """
        Send message with context to ChatGPT and return response.
    ...
    def format_prompt(self, message: str, context: Optional[List[str]] = None) -> str:
        """
        Format message and context into ChatGPT-specific prompt.
    ...
    def _format_messages(self, message: str, context: Optional[List[str]] = None) -> List[Dict[str, str]]:
        """
        Format message and context into OpenAI messages format.
    ...
    def handle_error(self, error: Exception) -> str:
        """
        Handle API errors gracefully with ChatGPT-specific messages.
        ...
        if "api key" in error_msg or "unauthorized" in error_msg:
            return "ChatGPT API authentication failed. Please check your OpenAI API key."
        elif "rate limit" in error_msg:
            return "ChatGPT API rate limit exceeded. Please wait a moment and try again."
        elif "timeout" in error_msg:
            return "ChatGPT API request timed out. Please check your internet connection and try again."
        elif "connection" in error_msg:
            return "Unable to connect to ChatGPT API. Please check your internet connection."
        else:
